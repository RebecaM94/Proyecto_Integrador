 ...
 * @retval                                 See @ref Common_Error_Codes or functions called by this function
 ...
 * @retval                          See @ref Common_Error_Codes for other possible return codes. This function calls
 *                                  * fmi_api_t::productFeatureGet
 ********************************************************************************************************************/
static ssp_err_t r_sci_spi_set_valid_interrupts_priority   (sci_spi_instance_ctrl_t * p_ctrl,
                                                             spi_cfg_t const * const p_cfg)
