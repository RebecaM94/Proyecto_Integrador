...
static uint32_t           g_clock_freq[CGC_CLOCK_PLL + 1]  BSP_PLACE_IN_SECTION_V2(".noinit");
/*LDRA_ANALYSIS */
...
void HW_CGC_SDADCClockCfg (R_SYSTEM_Type * p_system_reg, uint8_t clock)
{
...
uint8_t HW_CGC_SDADCClockCfgGet (R_SYSTEM_Type * p_system_reg)
{
...
void HW_CGC_SDADCClockEnable (R_SYSTEM_Type * p_system_reg)
{
...
void HW_CGC_SDADCClockDisable (R_SYSTEM_Type * p_system_reg)
{
...
bool HW_CGC_SDADCClockIsEnabled (R_SYSTEM_Type * p_system_reg)
{
