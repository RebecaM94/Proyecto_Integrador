...
//extern GX_NUMERIC_PROMPT_PROPERTIES window1_velocidad_properties;
		    ...
		    case SF_MESSAGE_EVENT_CLASS_TOUCH:
		    {
		        switch (p_message->event_b.code)
		        {
		            case SF_MESSAGE_EVENT_NEW_DATA:
		            {
		                ...
		                //new_gui_event = ssp_touch_to_guix((sf_touch_panel_payload_t*)p_message, &g_gx_event);  //Commentado para desabilitar touch
		            }
		            default:
		                break;
		        }
