...
#define HW_GPT_MSTPD5_MAX_CH (7U)
...
static const uint8_t g_bsp_module_stop[] =
{
    ...
    BSP_MSTP_REG(BSP_MSTPCRB) | BSP_MSTP_BIT(6U),                       // SSP_IP_QSPI=50,
    ...
    BSP_MSTP_REG(BSP_MSTPCRC) | BSP_MSTP_BIT(9U),                       // SSP_IP_SRC=53,
    ...
    BSP_MSTP_REG(BSP_MSTPCRB) | BSP_MSTP_BIT(15U),                      // SSP_IP_ETHER=64,    SSP_IP_EDMAC=64,
    BSP_MSTP_REG(BSP_MSTPCRB) | BSP_MSTP_BIT(13U) | BSP_MSTP_EXCEPTION, // SSP_IP_EPTPC=65,
    BSP_MSTP_REG(BSP_MSTPCRC) | BSP_MSTP_BIT(2U),                       // SSP_IP_PDC=66,
    BSP_MSTP_REG(BSP_MSTPCRC) | BSP_MSTP_BIT(4U),                       // SSP_IP_GLCDC=67,
    BSP_MSTP_REG(BSP_MSTPCRC) | BSP_MSTP_BIT(6U),                       // SSP_IP_DRW=68,
    BSP_MSTP_REG(BSP_MSTPCRC) | BSP_MSTP_BIT(5U),                       // SSP_IP_JPEG=69,
};
